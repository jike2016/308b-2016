...
class AJAXChat {
	...
	function initChannel() {
		...
		$channelName = $this->getRequestVar('channelName');
		if($channelID !== null) {
			//file_put_contents('123.txt', 'initChannel1:'.$channelName.":\r\n", FILE_APPEND);
			...
			//file_put_contents('123.txt', 'initChannel2:'.$channelName.":\r\n", FILE_APPEND);			
	...
	function initMessageHandling() {
		...
		if(!$this->validateChannel($this->getChannel())) {
			...
			//file_put_contents('123.txt', 'initMessageHandling'.$channelName.":\r\n", FILE_APPEND);
	...
	function insertParsedMessageJoin($textParts) {
		if(count($textParts) == 1) {
			...
			if($this->isAllowedToCreatePrivateChannel()) {
				...
				//file_put_contents('123.txt', 'insertParsedMessageJoin1:'.$channelName.":\r\n", FILE_APPEND);
			...
			//file_put_contents('123.txt', 'insertParsedMessageJoin2:'.$channelName.":\r\n", FILE_APPEND);

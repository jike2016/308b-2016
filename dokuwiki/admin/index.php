...
<body>
	<div id="layout">
		<div id="header">
			<div class="headerNav">
				<p style="font-family: 华文彩云; font-size: 50px;color: #d0d0d0" >百科后台管理</p>
				<ul class="nav">
			...
			<div id="sidebar">
				...
				<div class="accordion" fillSpace="sidebar">
					<div class="accordionHeader">
						<h2><span>Folder</span>百科管理</h2>
					</div>
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="application/word_manage.php" target="navTab" rel="word_manage">词条管理</a></li>
							<li><a href="application/category_manage.php" target="navTab" rel="category_manage">分类管理</a></li>
							<li><a href="application/examine_manage.php" target="navTab" rel="examine_manage">审核管理</a></li>
						</ul>
					</div>
				</div>
			</div>

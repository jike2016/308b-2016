...
<style>
	...
	.diff.diff_sidebyside{border: 0px !important; width: 100%;}
	.diff.diff_sidebyside td{border: 0px !important;}
	.diff.diff_sidebyside th{border: 0px; background-color: inherit;border-bottom: 1px solid #ccc; padding-bottom: 5px;}
	.diff.diff_sidebyside .diff-context {background-color: #f0f0f0;}
	.diff.diff_sidebyside .diff-addedline   { color: #3c763d;background-color: #dff0d8; border: 1px solid  #d6e9c6 !important;}
	.diff.diff_sidebyside .diff-deletedline { color: #a94442;background-color: #f2dede;border: 1px solid #ebccd1 !important;}
	...
	.diff.diff_sidebyside  td.diffnav:nth-child(1){padding-right: 0px; width: 50%;}
	.diff.diff_sidebyside  td.diffnav:nth-child(2){padding-left: 0px; width: 50%;}
	.diffbothprevrev:hover,.diffprevrev:hover,.diffnextrev:hover {color: #002DFF}
	/*3、版本对比界面 end*/

	/*修改词条的编辑按钮*/
	.secedit.editbutton_section .no>button{padding: 2px 5px;font-size: 12px;float: right}
</style>

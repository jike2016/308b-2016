...
<script>
	...
	//start 时间字符串转换为时间戳 dateStr = 2016-05-25 12:12:12
...
//			$(".table-box").load('person/learnledger.php?timeid='+documentlist_second_son_id+'&courseid='+documentlist_third_son_id+'&personid='+personid);

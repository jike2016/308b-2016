...
//$thinkphpurl = $_GET['client_id'].'&'.$_GET['client_secret'].'&'.$_GET['redirect_uri'].'&'.$_GET['response_type'];
$thinkphpurl = $_POST['thinkphpurl'];
...
$PAGE->set_url("$CFG->httpswwwroot/loginoauth/index.php?".$thinkphpurl);
$PAGE->set_context($context);
//$PAGE->set_pagelayout('loginpage');
$PAGE->set_pagelayout('loginoauthpage');
...
//        strpos($referer, $CFG->httpswwwroot . '/loginoauth/?'.$thinkphpurl) !== 0 &&
//        strpos($referer, $CFG->httpswwwroot . '/loginoauth/index.php?'.$thinkphpurl) !== 0) { // There might be some extra params such as ?lang=.
...
if (!empty($SESSION->loginerrormsg)) {
    ...
    redirect(new moodle_url('/loginoauth/index.php?'.$thinkphpurl));
}

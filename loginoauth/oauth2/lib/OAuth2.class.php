...
//define("OAUTH2_ERROR_INVALID_REQUEST", "该请求缺少必须的参数或者参数名称有误");
...
//define("OAUTH2_ERROR_INVALID_CLIENT", "提供的客户端标识符无效");
...
//define("OAUTH2_ERROR_UNAUTHORIZED_CLIENT", "未授权的响应类型");
...
//define("OAUTH2_ERROR_REDIRECT_URI_MISMATCH", "提供的回调地址有误");
...
//define("OAUTH2_ERROR_USER_DENIED", "服务器拒绝请求");
...
//define("OAUTH2_ERROR_UNSUPPORTED_RESPONSE_TYPE", "未受支持的服务类型");
...
//define("OAUTH2_ERROR_INVALID_SCOPE", "请求范围无效");
...
//define("OAUTH2_ERROR_INVALID_GRANT", "附带的访问许可无效");
...
//define("OAUTH2_ERROR_UNSUPPORTED_GRANT_TYPE", "未受支持的访问许可");
...
//define("OAUTH2_ERROR_INVALID_TOKEN", "访问令牌过期或者无效");
...
//define("OAUTH2_ERROR_EXPIRED_TOKEN", "访问令牌已过期");
...
//define("OAUTH2_ERROR_INSUFFICIENT_SCOPE", "请求需要比访问令牌提供更高的权限");

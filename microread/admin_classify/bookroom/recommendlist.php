...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="edit" href="bookroom/recommendlist_edit.php?recommendid={recommendid}" target="dialog"><span>设置</span></a></li>
	...
	<table class="table" width="30%" layoutH="138">
		...
		global $DB;
		$recommends=$DB->get_records_sql('select a.id,b.name from mdl_ebook_recommendlist_my as a LEFT JOIN mdl_ebook_my b on a.ebookid=b.id order by a.id');

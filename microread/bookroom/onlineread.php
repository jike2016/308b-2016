		...
		<div class="main">
			<div class="book-box">
				...
				<div class="bottom-info">
					<a href="onlineread.php?bookid=<?php echo $bookid; ?>&booksectionid=<?php echo $lastsectionid; ?>">上一节</a>&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="bookindex.php?bookid=<?php echo $bookid; ?>">章节目录</a>&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="onlineread.php?bookid=<?php echo $bookid; ?>&booksectionid=<?php echo $nextsectionid; ?>">下一节</a>
				</div>
			</div>
		</div>
		<!--页面主体 end-->

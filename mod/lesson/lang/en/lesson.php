...
$string['completionendreached'] = '无';
$string['completionendreached_desc'] = '无';
$string['completiontimespent'] = '学生需要观看视频至少';
$string['completiontimespentgroup'] = '时间规定';
...
$string['notenoughtimespent'] = '你目前已观看： {$a->timespent}, 少于此视频所需要的最少时间： {$a->timerequired}. 因此你需要继续观看此视频.';

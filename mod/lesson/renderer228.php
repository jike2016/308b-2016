...
class mod_lesson_renderer extends plugin_renderer_base {
    ...
    /// Header setup
        ...
        if (has_capability('mod/lesson:manage', $context)) {
            ...
            /** START 叶靖华 视频播放学生页面头部输出 20160227*/
            $output .=html_writer::start_tag('div',array('class'=>'videotitle'));
            $output .=html_writer::start_tag('a', array('href'=>'#'));
            $output .=html_writer::start_tag('span', array('class'=>'glyphicon glyphicon-expand'));

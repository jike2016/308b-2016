...
if ($mform->is_cancelled()) {
	//按了取消按钮
	redirect(new moodle_url('/mod/notemy/newnotemy_personal.php'));
	...
	$noteArray->notetype = 2;//笔记类型 1:课程笔记 2:个人笔记
...
//	redirect(new moodle_url('/mod/notemy/index.php'));
	$url = new moodle_url('/mod/notemy/newnotemy_personal.php', array('id' => $newid));

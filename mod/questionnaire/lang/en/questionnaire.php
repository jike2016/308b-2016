...
$string['completionsubmit'] = '学生必须提交问卷调查才能完成该活动';
...
$string['questionnaire:message'] = '发送消息给未参加问卷调查者';
...
$string['show_nonrespondents'] = '没有受访者';
...
$string['viewindividualresponse'] = '无效的回答';

...
if($attemptobj->has_capability('mod/quiz:manage')){
    $PAGE->set_pagelayout('quizprint');//设置layout文件,能打印
    //默认为incourse
}
/** End */
// Check the access rules.
/** Start 20160113 把管理员的时间提前2分钟  韦鲲鹏 岑霄**/
if(isset($_SESSION['unified_quiz'])&&$_SESSION['unified_quiz']) {
    $accessmanager = $attemptobj->get_access_manager(time()+120);//管理员提前2分钟
} else {
...
/** Start 20160113 判断是生成统一考试按钮提交过来，生成session  韦鲲鹏 岑霄**/
if(isset($_SESSION['unified_quiz'])&&$_SESSION['unified_quiz']) {

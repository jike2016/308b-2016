...
//				console.log(arrayObj);
	...
	<style>
		...
		.table-box-title h3 .t {color: #0078E7;}
...
<div class="table-box-alert">
	<div class="table-box-title">
		<h3 class="conversation-box-title"><span class="t">查看</span><span class="close-btn">X</span></h3>
	</div>
	...
	<div class="submit-box">
		<button class="btn btn-primary" id="submitadd">确认</button>
	</div>
</div>
<!--</form>-->

...
<header role="banner">
	...
	<div id="bg" style="width:100%; height:460px;">
	<button class="btn bannerbtn" style=" float:left;" onClick="JavaScript:change(0)"><span class="glyphicon glyphicon-chevron-left"></span></button>
	<div style=" float:left; height:30px; width:80%; margin:450px 0px 0px 0px;">
		<div style="float:right; width:20%; margin:auto">
    		<a href="#"><div class="smbtn" id="img0" style="background-color:#0C3;"></div></a>
    		<a href="#"><div class="smbtn" id="img1"></div></a>
    		<a href="#"><div class="smbtn" id="img2"></div></a>
    		<a href="#"><div class="smbtn" id="img3"></div></a>
    		<a href="#"><div class="smbtn" id="img4"></div></a>
    	</div>
	</div>

    <button class="btn bannerbtn"  style="float:right;" onClick="change(1)"><span class="glyphicon glyphicon-chevron-right"></span></button>
	</div> 
</header>
...
<script src="<?php echo $CFG->wwwroot;?>/themechange/js/style.js"></script>
</html>

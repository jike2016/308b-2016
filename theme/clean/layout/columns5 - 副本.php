...
<div style="width:1200px; margin:auto; height:1000px">
	...
	<div style="float:left; width:18%; padding:0px">    	
    	...
    	<button type="button" class="btn btn-lg btn-block bgreen" style="margin:0; border-radius:0; border-top:0px">
        	<div style="padding:8px 0">
            <p style="float:left; font-size:16px">全部课程</p>
            <p style="float:right; font-size:16px">580</p>
            </div>
        </button>
		<button type="button" class="btn btn-lg btn-block bgreen" style="margin:0; border-radius:0;">
        	<div style="padding:8px 0">
            <p style="float:left; font-size:16px">文学艺术</p>
            <p style="float:right; font-size:16px">70</p>
            </div>
        </button>
        <button type="button" class="btn btn-lg btn-block bgreen" style="margin:0; border-radius:0;">
        	<div style="padding:8px 0">
            <p style="float:left; font-size:16px">哲学历史</p>
            <p style="float:right; font-size:16px">580</p>
            </div>
        </button>
        <button type="button" class="btn btn-lg btn-block bgreen" style="margin:0; border-radius:0;">
        	<div style="padding:8px 0">
            <p style="float:left; font-size:16px">经管法学</p>
            <p style="float:right; font-size:16px">580</p>
            </div>
        </button>
        <button type="button" class="btn btn-lg btn-block bgreen" style="margin:0; border-radius:0;">
        ...
        </button><button type="button" class="btn btn-lg btn-block bgreen" style="margin:0; border-radius:0;">
        	<div style="padding:8px 0">
            <p style="float:left; font-size:16px">经管法学</p>
            <p style="float:right; font-size:16px">580</p>
            </div>
		...
		<div style="width:100%; margin:10px 0px;">
  			<button class="btn btn-sm btn-default" style="float:left; width:20%; border-radius:0px;"><span class="glyphicon glyphicon-search" id="basic-addon1"></span></button>
  			<input type="text" class="form-control" placeholder="搜索" aria-describedby="basic-addon1" style=" width:72%;height:22px; float:right; border-radius:0px;">
		</div>

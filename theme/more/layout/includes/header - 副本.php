	...
	<script>
		$(document).ready(function(){ 
    		$('.bgreen').click(function(){
    			$('.bgreen').removeClass('bgreen_active');
				$(this).addClass('bgreen_active');
			});
			$('.greenbutton').click(function(){
    			$('.greenbutton').removeClass('greenbutton_active');
				$(this).addClass('greenbutton_active');
			});
		});
   	</script>
    <style>
    ...
    <div class="loginwrap">
      ...
      <form action="<?php echo $CFG->wwwroot;?>/login/index.php" method="post" id="login">
        <div class="logininput">
          <input type="text" name="username" id="username" class="loginusername" value="用户名" />
          <input type="text" class="loginuserpasswordt" value="密码" />
          <input type="password" name="password" id="password" class="loginuserpasswordp" style="display:none" />
        </div>
        <div class="loginbtn">

...
//<!--		--><?php ////echo '<script src="../theme/more/js/jquery-1.11.3.min.js" ></script>'; ?>
	}
</script>
				...
				<div class="input-group">
					...
					<?php
						if(isset($_GET['searchParam'])){
							echo '<input type="text" id="search_param" class="form-control" value="'.$_GET['searchParam'].'" >';
						}else{
							echo '<input type="text" id="search_param" class="form-control" >';
						}
					?>
				</div><!-- /input-group -->

								...
								foreach ($categorys as $category) {
									...
									foreach($category_twos as $category_two){
										...
										$category_two_html .= '<dl class="flright">
																<dt>'.$category_two->name.'</dt>
																<dd>
																	 <a href="'.$CFG->wwwroot.'/course/index.php?dep1categoryid='.$category->id.'&dep2categoryid='.$category_two->id.'&sortkind=1">最新</a>
																	 <a href="'.$CFG->wwwroot.'/course/index.php?dep1categoryid='.$category->id.'&dep2categoryid='.$category_two->id.'&sortkind=2">周热门</a>
																	 <a href="'.$CFG->wwwroot.'/course/index.php?dep1categoryid='.$category->id.'&dep2categoryid='.$category_two->id.'&sortkind=3">月热门</a>
																	 <a href="'.$CFG->wwwroot.'/course/index.php?dep1categoryid='.$category->id.'&dep2categoryid='.$category_two->id.'&sortkind=4">总热门</a>
																	 <a href="'.$CFG->wwwroot.'/course/index.php?dep1categoryid='.$category->id.'&dep2categoryid='.$category_two->id.'&sortkind=5">好评榜</a>
																</dd>
															</dl>';
									}
									$category_two_html .= '</div>
	            											<!--分类'.$n.' end-->';
									$output .= '
														</dd>
													</dl>
...
//								$categorys = $DB->get_records_sql('select name,id FROM mdl_course_categories where depth=1 and visible=1 ORDER BY sortorder;');
			...
			<ul class="navRight">
				...
				<li><a href="<?php echo $CFG->wwwroot;?>/privatecenter/index.php">直播</a></li>
				<li><a href="<?php echo $CFG->wwwroot;?>/privatecenter/">个人中心</a></li>
			</ul>
		</div>
	</div>
	<!-- 轮播广告 -->

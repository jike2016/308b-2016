...
global $USER;
$org = new org();
$treeNode = $org->get_nodeid_with_userid($USER->id);
if(isset($_GET["id"])&&$_GET["id"]){
	$tree = $org->show_node_tree_collective_learning($treeNode,$_GET["id"]);
}
...
//		添加人员
		...
		$(document).ready(function(){
			...
			$('#add').on('click', function(){      //添加按钮动作
				...
				{
					$.ajax({
						url: "<?php echo $CFG->wwwroot;?>/org/orgCRUD.php",
						dataType:"json",
						data: { treeNodeid: treenode_orgid, type: 'click_all_user_not_self'},

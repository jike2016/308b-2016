	...
	protected function my_print_index_category(){
		echo '<div class="catagory">
			<div class="catagory-item" style="">
				<a href="<?php echo $CFG->wwwroot;?>/course/index.php?dep1categoryid=2" class="catagory-title">
			...
			<div class="catagory-item" style="">
				<a href="<?php echo $CFG->wwwroot;?>/course/index.php?dep1categoryid=3" class="catagory-title">
					<span class="catagory-icon">            
			...
			<div class="catagory-item" style="">
				<a href="<?php echo $CFG->wwwroot;?>/course/index.php?dep1categoryid=4" class="catagory-title">
					<span class="catagory-icon">       
			...
			<div class="catagory-item" style="margin-right:0;">
				<a href="<?php echo $CFG->wwwroot;?>/course/index.php?dep1categoryid=11" class="catagory-title">
					<span class="catagory-icon">         
